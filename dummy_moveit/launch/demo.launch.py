...
def generate_launch_description():
    ...
    joint_limits_yaml = load_yaml(
        "dummy_moveit", "config/joint_limits.yaml"
    )
    pilz_cartesian_limits_yaml = load_yaml(
        "dummy_moveit", "config/pilz_cartesian_limits.yaml"
    )
    ...
    kinematics_yaml = load_yaml(
        "dummy_moveit", "config/kinematics.yaml"
    )
    ...
    ompl_planning_yaml = load_yaml(
        "dummy_moveit", "config/ompl_planner.yaml"
    )
    planning_pipelines_config["ompl"].update(ompl_planning_yaml)

    # Trajectory Execution Functionality
    moveit_simple_controllers_yaml = load_yaml(
        "dummy_moveit", "config/moveit_controllers.yaml"
    )
    moveit_controllers = {
    ...
    rviz_base = os.path.join(
        get_package_share_directory("dummy_moveit"), "config"
    )
